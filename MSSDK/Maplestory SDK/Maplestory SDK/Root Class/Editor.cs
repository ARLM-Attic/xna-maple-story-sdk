...
namespace Maplestory_SDK.Root_Class
{
    class Editor
    {
        ...
        /// <summary>
        /// Khởi tạo Editor để tạo map và các thứ khác
        /// </summary>
        /// <param name="graphics">Mặc định là : GraphicsDevice</param>
        ...
        /// thuộc 1 layer mới nằm trên layer map
        /// </summary>
        /// <param name="spriteBatch"></param>
        /// <param name="crosshair"></param>
        /// <param name="gridCell">ô chia vuông</param>
        /// <param name="tileSheet">title set</param>
        /// <param name="windowColor">Màu nền đằng sau của panel editor</param>
